# recargoconsumo serverless API
The recargoconsumo project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=recargoconsumo -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot-archetype -DarchetypeVersion=1.4 -DgroupId=com.zugatti -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd recargoconsumo
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "RecargoconsumoApi",
                    "OutputKey": "RecargoconsumoApi",
